...
\begin{document}
	...
	\begin{multicols}{3}
		...
		\subsection{AR(1) Models}
			...
			\rho_0 = 1 \\
			\rho_k = \theta_1^k \\
			\sigma_X^2 = \frac{\sigma_a^2}{1 - \theta_1^2}
			\end{align*}
		...
		\subsection{AR(2) Models}
			...
			\rho_0 = 1 \\
			\rho_1 = \frac{\theta_1}{1 - \theta_2} \\
			\rho_2 = \frac{\theta_1^2 + \theta_2 - \theta_2^2}{1 - \theta_2} \\
			\sigma_X^2 = \frac{1}{1 - \theta_1\rho_1 - \theta_2\rho_2}
			\end{align*}
